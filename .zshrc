...
# Type "up <num>" to cd x directories back, or "up <folder prefix> cd to that prefix
# Ie. "up 3" = "cd ../../.."
# Ie. from ~/MLH/projects/solana, "up M" will cd to ~/MLH
# Case sensitive.
up() {
  local op=print
  [[ -t 1 ]] && op=cd
...
source ~/.config/zsh-system-clipboard/zsh-system-clipboard.zsh
